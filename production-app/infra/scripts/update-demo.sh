...
PUBLIC_URL="https://delegateops.business/demo/pimascor/"
...
grep -Fq 'revision: str = "20260812_0015"' "${SOURCE_ROOT}/apps/api/migrations/versions/20260812_0015_support_tickets.py" || {
